...
public:
    ...
    {
        // nodes of a graph
        GraphNode<string> gnode0 = GraphNode<string>("0");
        GraphNode<string> gnode1 = GraphNode<string>("1");
        GraphNode<string> gnode2 = GraphNode<string>("2");
        GraphNode<string> gnode3 = GraphNode<string>("3");
        GraphNode<string> gnode4 = GraphNode<string>("4");
        ...
        // wrap to a graph
        Graph<string> graph = Graph<string>(gnode0);
        GraphNode<string> graphRoot = graph.root;
        graphRoot.add(GraphNode<string>("5"), 11);
        gnode1.add(GraphNode<string>("6"), 12);
        gnode2.add(GraphNode<string>("7"), 13);
    ...
    {
        queue<GraphNode<string>> q = queue<GraphNode<string>>();
        q.push(node);
